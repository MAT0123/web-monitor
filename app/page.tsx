      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {websites.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">Add your first website to start monitoring its uptime</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {websites.map((website) => (
              <WebsiteCard key={website.id} website={website} onUpdate={fetchWebsites} />
            ))}
          </div>
        )}
      </div>
